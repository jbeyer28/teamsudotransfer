...
<html lang="en-us">
<html>
<title>Sudo LED Strip - Sudo Store</title>
	...
	<tr>
		...
		<td colspan="3">
			<table width="100%" cellpadding="10px" cellspacing="0px">
				<tr>
					<td >
						<img width=500px height=450px src="../img/LightstripNoBG.png">
					</td>
					<td>
						<div class="productDescription">
						<font size=7 id="productName"><b>Sudo LED Strip</b></font><br>
						<p>Light up your life and gaming space with this programmable, 30' LED strip!<br></p><br><br>
