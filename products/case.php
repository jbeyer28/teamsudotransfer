...
<html lang="en-us">
<html>
<title>Sudo Case - Sudo Store</title>
...
<body>
	...
	<tr>
		<td>
			<a href="ram.php"><img id="sideAd" src="../frontpage Images/RamVertAd.png" width="300px" height="1000px"></a>
		</td>
		<td colspan="3">
			<table width="100%" cellpadding="10px" cellspacing="0px">
				<tr>
					<td >
						<img width=500px height=450px src="../img/caseNoBG.png">
					</td>
					<td >
						<div class="productDescription">
						<font size=7 id="productName"><b>Sudo Case</b></font><br>
						<p >Our massive PC case that is perfect for any enthusiast build. <br>Built in RGB lighting with over 10,000 colors!</p><br><br>
						
						<p style=" font-size: 20px">$45 <sup>tax not included</sup> </p><br><br>
