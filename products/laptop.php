...
<html lang="en-us">
<html>
<title>Sudo Laptop - Sudo Store</title>
	...
	<tr>
		...
		<td colspan="3">
			<table width="100%" cellpadding="10px" cellspacing="0px">
				<tr>
					<td >
						<img width=500px height=450px src="../img/LaptopNoBG.png">
					</td>
					<td>
						<div class="productDescription">
						<font size=7 id="productName"><b>Sudo Laptop</b></font><br>
						<p>The SUDO gaming laptop comes complete with the <br>most powerful laptop components available!</p><br><br>
						
						<p style=" font-size: 20px">$3000 <sup>tax not included</sup> </p><br><br>
