...
<html lang="en-us">
<html>
<title>Sudo Speakers - Sudo Store</title>
	...
	<tr>
		...
		<td colspan="3">
			<table width="100%" cellpadding="10px" cellspacing="0px">
				<tr>
					<td >
						<img width=500px height=450px src="../img/speakers.png">
					</td>
					<td>
						<div class="productDescription">
						<font size=7 id="productName"><b>Sudo Speakers</b></font><br>
						<p>A 9.1 speaker surround sound setup that is sure to give<br> you the ultimate immersive experience.</p><br><br>
