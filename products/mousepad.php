...
<html lang="en-us">
<html>
<title>Sudo Mousepad - Sudo Store</title>
	...
	<tr>
		...
		<td colspan="3">
			<table width="100%" cellpadding="10px" cellspacing="0px">
				<tr>
					<td >
						<img width=500px height=450px src="../img/MousepadNoBG.png">
					</td>
					<td>
						<div class="productDescription">
						<font size=7 id="productName"><b>Sudo Mousepad</b></font><br>
						<p>A mousepad guaranteed to support your wrist while throwin frags in MAG <br> and provide deep comfort through hours of playtime!</p><br><br>
						
						<p style=" font-size: 20px">$80 <sup>tax not included</sup> </p><br><br>
