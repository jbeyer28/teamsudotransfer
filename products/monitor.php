...
<html lang="en-us">
<html>
<title>Sudo Monitor - Sudo Store</title>
	...
	<tr>
		...
		<td colspan="3">
			<table width="100%" cellpadding="10px" cellspacing="0px">
				<tr>
					<td >
						<img width=500px height=450px src="../img/MonitorNoBG.png">
					</td>
					<td>
						<div class="productDescription">
						<font size=7 id="productName"><b>Sudo Monitor</b></font><br>
						<p>The official SUDO brand HD monitor!<br>Ultrawide, 4K resolution and 1ms refresh rate.</p><br><br>
						
						<p style=" font-size: 20px">$500 <sup>tax not included</sup> </p><br><br>
