	...
	<tr>
		...
		<td colspan="3">
			<table width="100%" cellpadding="10px" cellspacing="0px">
				<tr>
					<td >
						<img width=500px height=450px src="../img/CpuFanNoBG.png">
					</td>
					<td>
						<div class="productDescription">
						<font size=7 id="productName"><b>Sudo CPU Fan</b></font><br>
						<p >This CPU fan can handle the heaviest overclocking settings <br>and keep your rig liquid nigrogen cold.</p><br><br>
